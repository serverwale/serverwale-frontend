...
import { X, Phone, User, Mail, CheckCircle, Loader2, DollarSign, Briefcase } from "lucide-react";
...
const PricingRequestModal: React.FC<PricingRequestModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        setSubmitted(true);
        setFormData({ name: "", phone: "", serviceType: "", email: "" });
      } else {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-in-up">
        ...
        <div className="bg-gradient-to-r from-[#0F172A] to-[#1e293b] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-white">Request Pricing</h2>
          </div>
          ...
          {submitted ? (
            ...
            <div className="text-center py-4">
              ...
              <p className="text-slate-600 mb-2">
                Thanks for showing interest. Our team will call you shortly.
              </p>
              <p className="text-sm text-slate-500 mb-4">
                If it's urgent, please call us on our support number.
              </p>
              <div className="bg-blue-50 rounded-lg p-3 mb-4">
                <p className="text-sm font-medium text-[#0055E5]">📞 Support: +91 800 887 6050</p>
              </div>
              <button
                onClick={handleClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#0055E5] outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Eg: Cloud Hosting, VPS, Dedicated Server"
                    required
                    className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#0055E5] outline-none"
                  />
                </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#0F172A] hover:bg-[#0044BB] disabled:opacity-50 text-white py-3 rounded-lg font-semibold transition flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
